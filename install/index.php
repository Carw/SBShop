 ...
 */
if(is_file('../assets/extends/sbshop/version.inc.php')) {
	require_once('../assets/extends/sbshop/version.inc.php');
} else {
	$sbshop_version = '';
	$sbshop_release_date = '';
}
...
$moduleName = "SBShop";
$moduleVersion = $sbshop_version;
$moduleRelease = $sbshop_release_date;
